...
const Projects = () => {
    ...
    const img1 = "https://res.cloudinary.com/oladipupoademola/image/upload/v1717601046/Frame_4_ezocat.png"
    const img2 = "https://res.cloudinary.com/oladipupoademola/image/upload/v1717601989/Frame_11_uwkuqi.png" 
    const img3 = "https://res.cloudinary.com/oladipupoademola/image/upload/v1717601989/Frame_5_lfapbf.png"
  ...
  return (
    <>
    <div className='bg-[#00030C] h-full'>
